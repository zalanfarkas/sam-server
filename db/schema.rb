...
ActiveRecord::Schema.define(version: 20180309160137) do

  create_table "absence_certificates", force: :cascade do |t|
    t.integer "student_id"
    t.integer "course_id"
    t.string "certificate_type"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["course_id"], name: "index_absence_certificates_on_course_id"
    t.index ["student_id"], name: "index_absence_certificates_on_student_id"
  end
  ...
  create_table "pending_practicals", force: :cascade do |t|
    t.string "raspberry_pi_id"
    t.integer "practical_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["practical_id"], name: "index_pending_practicals_on_practical_id"
    t.index ["raspberry_pi_id"], name: "index_pending_practicals_on_raspberry_pi_id", unique: true
  end
