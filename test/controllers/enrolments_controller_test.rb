...
class EnrolmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enrolment" do
    assert_difference('Enrolment.count') do
      post enrolments_url, params: { enrolment: { course_id: @enrolment.course_id, student_id: @enrolment.student_id } }
    end
  ...
  test "should update enrolment" do
    patch enrolment_url(@enrolment), params: { enrolment: { course_id: @enrolment.course_id, student_id: @enrolment.student_id } }
